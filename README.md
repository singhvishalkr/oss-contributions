...
Detailed companion to **[github.com/singhvishalkr](https://github.com/singhvishalkr)**. Below: where public PRs landed, with tables and links. Counts are **cumulative** (merged, open, and closed PRs over several years).

## Summary

| | |
| --- | --- |
| PRs authored (**@singhvishalkr**) | **100+** |
| Distinct upstream repositories | **25+** |
